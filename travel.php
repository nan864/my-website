...
<body>
  ...
  <main class="container p-4">
    ...
    <p>
        PKC 2024 will be held in central Sydney, New South Wales, Australia.
        If you are not already in Sydney, you will almost certainly need to fly here. If you
        fly in to Melbourne, Brisbane or Perth, you will need to fly from there too.
    </p>
      <p>
          Fortunately Sydney has a convenient rail line from the airport to the city centre.
      </p>
      <p>
